        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <form class="form-row" action="{{ route('contacto.mail') }}" method="post">
                    ...
                    <div class="col-md-12  ">
                        <button type="submit" onclick="gtag_report_conversion()" class="btn text-dark px-5 my-4 baires-fondo rounded-pill">{{ __('Submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LctaZkUAAAAAHIb3UhjrSgDNxtVa_ye3Ut1UwWY', {action: 'homepage'}) 
        });
    </script>
