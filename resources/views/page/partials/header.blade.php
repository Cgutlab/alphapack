<div class="fixed-top fixed-top-sm">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-0" style="box-shadow: unset;">
...
{{--                        </div>--}}
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('nosotros') }}" href="{{ route('nosotros') }}">{{ __('About us') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('productos/1') }}" href="{{ route('productos',['general' => 1]) }}">{{ __('Packaging') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('productos/2') }}" href="{{ route('productos',['general' => 2]) }}">{{ __('Dosing') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('productos/3') }}" href="{{ route('productos',['general' => 3]) }}">{{ __('Accessory') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('noticias') }}" href="{{ route('noticias') }}">{{ __('News') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('post-venta') }}" href="{{ route('post.venta') }}">{{ __('Post-Sale') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('videos') }}" href="{{ route('videos') }}">{{ __('Videos') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2 {{ active('contacto') }}" href="{{ route('contacto') }}">{{ __('Contact') }}</a></li>
                    <li class="nav-item"><a style="color:black;" class="nav-link  ml-2" href="#buscar" data-toggle="modal"><i class="fas fa-search prefix rounded-pill p-1"  style="border: 2px solid #33AEED;"></i></a></li>
